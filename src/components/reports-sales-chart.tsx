...
export function ReportsSalesChart({ data }: { data: ChartData[] }) {
            ...
            formatter={(value, name, props) => {
              return (
                <div className="flex flex-col">
                  ...
                  <span className="font-bold">{new Intl.NumberFormat('es-MX', { style: 'currency', currency: 'MXN' }).format(value as number)}</span>
                </div>
              )
            }}
          />}
